...
export default function OrderForm({ action, data, getEmployees, hide }) {
    const token = window.localStorage.getItem("token");
    const url =
        action === "add"
            ? process.env.REACT_APP_API_URL + "/admin/employees/create"
            : process.env.REACT_APP_API_URL + "/admin/employees/update";
