...
export default function PatientForm({ action, data, getPatients, hide }) {
    const token = window.localStorage.getItem("token");
    const url =
        action === "add"
            ? process.env.REACT_APP_API_URL + "/admin/patients/create"
            : process.env.REACT_APP_API_URL + "/admin/patients/update";
