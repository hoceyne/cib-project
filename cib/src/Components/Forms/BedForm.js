...
export default function BedForm({ action, data, getBeds, hide }) {
    const token = window.localStorage.getItem("token");
    const url =
        action === "add"
            ? process.env.REACT_APP_API_URL + "/admin/beds/create"
            : process.env.REACT_APP_API_URL + "/admin/beds/update";
    ...
    return (
        <div className="relative flex flex-col max-w-[70%] break-words w-full bg-slate-100  shadow-lg rounded-2xl border-0 m-auto">
